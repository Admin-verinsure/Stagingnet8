...
{
    public class MREFIDUWModule : IUnderwritingModule
    {
        public string Name { get; protected set; }

        public MREFIDUWModule()
        {
            Name = "MRE_FID";
        }
        ...
        public bool Underwrite(User underwritingUser, ClientInformationSheet informationSheet, Product product, string reference)
        {
            ...
            if (agreement.ClientInformationSheet.IsChange && agreement.ClientInformationSheet.PreviousInformationSheet != null)
            {
                ...
                var PreviousAgreement = agreement.ClientInformationSheet.PreviousInformationSheet.Programme.Agreements.FirstOrDefault(p => p.ClientAgreementTerms.Any(i => i.SubTermType == "FID"));
            ...
            string auditLogDetail = "MRE FID UW created/modified";

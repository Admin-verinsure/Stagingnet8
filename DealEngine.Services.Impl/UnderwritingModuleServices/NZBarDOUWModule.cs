...
{
    public class NZBarDOUWModule : IUnderwritingModule
    {
        public string Name { get; protected set; }

        public NZBarDOUWModule()
        {
            Name = "NZBar_DO";
        }
        ...
        public bool Underwrite(User underwritingUser, ClientInformationSheet informationSheet, Product product, string reference)
        {
            ...
            IDictionary<string, decimal> rates = BuildRulesTable(agreement, "dotermlimit", "dotermexcess", "dotermpremium");
            ...
            TermPremium = rates["dotermpremium"];
            ...
            string auditLogDetail = "NZBar DO UW created/modified";

...
{
    public class NZPIPIUWModule2022 : IUnderwritingModule
    {
        public string Name { get; protected set; }

        public NZPIPIUWModule2022()
        {
            Name = "NZPI_PI_2022";
        }
        ...
        public bool Underwrite(User underwritingUser, ClientInformationSheet informationSheet, Product product, string reference)
        {
            ...
            IDictionary<string, decimal> rates = BuildRulesTable(agreement, "1millimitpremium1employee",
                ...
                "2millimitpremiumover2employee", "5millimitpremiumover2employee", "noemplyeepremiumreduction", "maxfeeincome", "pibrokerfee");
            ...
            decimal TermPremiumReduction = 0M;
            if (agreement.ClientInformationSheet.Answers.Where(sa => sa.ItemName == "EPLViewModel.HaveAnyEmployeeYN").Any())
            {
                if (agreement.ClientInformationSheet.Answers.Where(sa => sa.ItemName == "EPLViewModel.HaveAnyEmployeeYN").First().Value == "2")
                {
                    TermPremiumReduction = rates["noemplyeepremiumreduction"];
                }
            }

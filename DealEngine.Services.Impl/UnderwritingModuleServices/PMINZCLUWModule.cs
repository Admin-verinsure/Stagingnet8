...
namespace DealEngine.Services.Impl.UnderwritingModuleServices
{
    public class PMINZCLUWModule : IUnderwritingModule
    {
        ...
        public bool Underwrite(User underwritingUser, ClientInformationSheet informationSheet, Product product, string reference)
        {
            ...
            string retrodate = agreement.InceptionDate.ToString("dd/MM/yyyy");  //"Inception or Date since CL policy first held"
            ...
            {
                var PreviousAgreement1 = agreement.ClientInformationSheet.PreviousInformationSheet.Programme.Agreements.FirstOrDefault(p => p.ClientAgreementTerms.Any(i => i.SubTermType == "CL"));

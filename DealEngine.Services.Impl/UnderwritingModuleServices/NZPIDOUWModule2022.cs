...
{
    public class NZPIDOUWModule2022 : IUnderwritingModule
    {
        public string Name { get; protected set; }

        public NZPIDOUWModule2022()
        {
            Name = "NZPI_DO_2022";
        }
        ...
        public bool Underwrite(User underwritingUser, ClientInformationSheet informationSheet, Product product, string reference)
        {
            ...
            IDictionary<string, decimal> rates = BuildRulesTable(agreement, "maximumassetsize", "do500klimitpremium1employee", "do500klimitpremium2employee", "do500klimitpremiumover2employee");
            ...
            {
                TermPremium500k = rates["do500klimitpremium1employee"];
            }
            else if (intnumberofadvisors == 2)
            {
                TermPremium500k = rates["do500klimitpremium2employee"];
            }
            else if (intnumberofadvisors > 2)
            {
                TermPremium500k = rates["do500klimitpremiumover2employee"];
            }

...
{
    public class NZBarPLUWModule : IUnderwritingModule
    {
        public string Name { get; protected set; }

        public NZBarPLUWModule()
        {
            Name = "NZBar_PL";
        }
        ...
        public bool Underwrite(User underwritingUser, ClientInformationSheet informationSheet, Product product, string reference)
        {
            ...
            IDictionary<string, decimal> rates = BuildRulesTable(agreement, "pltermlimit", "pltermexcess", "pltermpremium");
            ...
            TermPremium = rates["pltermpremium"];
            ...
            string auditLogDetail = "NZBar PL UW created/modified";

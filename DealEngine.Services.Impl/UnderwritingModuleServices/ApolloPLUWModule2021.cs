...
{
    public class ApolloPLUWModule2021 : IUnderwritingModule
    {
        public string Name { get; protected set; }

        public ApolloPLUWModule2021()
        {
            Name = "Apollo_PL_2021";
        }
        ...
        public bool Underwrite(User underwritingUser, ClientInformationSheet informationSheet, Product product, string reference)
        {
            ...
            IDictionary<string, decimal> rates = BuildRulesTable(agreement, "pltermlimit", "pltermexcess", "pltermpremiumclass1", "pltermpremiumclass1noemp", "below500kfeeincomebasepremium",
                "below500kfeeincomebasepremiumnoemp", "500kto750kfeeincomebasepremium", "500kto750kfeeincomebasepremiumnoemp", "750kto1milfeeincomebasepremium", "750kto1milfeeincomebasepremiumnoemp",
                "1milto1andhalfmilfeeincomebasepremium", "1milto1andhalfmilfeeincomebasepremiumnoemp", "1andhalfmilto2milfeeincomebasepremium", "1andhalfmilto2milfeeincomebasepremiumnoemp",
                "2milto3milfeeincomebasepremium", "2milto3milfeeincomebasepremiumnoemp", "pltermpremiumtopup");
            ...
            if (agreement.ClientInformationSheet.RoleData != null)
            {
                foreach (var role in agreement.ClientInformationSheet.RoleData.DataRoles)
                {
                    if (role.Name == "Partners / Principals / Directors" || role.Name == "Qualified Staff")
                    {
                        rolenumber += role.Total;
                    }
                }
            }
            ...
            if (agreement.ClientInformationSheet.Answers.Where(sa => sa.ItemName == "EPLViewModel.HaveAnyEmployeeYN").First().Value == "1")
            {
                employeenumber = Convert.ToInt32(agreement.ClientInformationSheet.Answers.Where(sa => sa.ItemName == "EPLViewModel.TotalEmployees").First().Value);
            }
            ...
            if (agreement.ClientInformationSheet.Answers.Where(sa => sa.ItemName == "PIViewModel.HasClassOfLicense").Any())
            {
                ...
                {
                    classoption = 2;
                    TermPremium = GetPLPremium(rates, feeincomelastyear, rolenumber, employeenumber, classoption);
                }
            ...
            //Fee Income Over $3mil
            uwrffeeincomeover3mil(underwritingUser, agreement, feeincomelastyear);
            //Advisor No Over 20
            uwrfadvisornumberover20(underwritingUser, agreement, rolenumber);
            //ML programme only
            if (agreement.ClientInformationSheet.Programme.BaseProgramme.NamedPartyUnitName == "Apollo ML Programme")
            {
        ...
        decimal GetPLPremium(IDictionary<string, decimal> rates, decimal feeincome, int rolenumber, int employeenumber, int classoption)
        {
            ...
            if (rolenumber < 2)
            {
                if (employeenumber > 0)
                {
                    premium = rates["pltermpremiumclass1"];
                } else
                {
                    premium = rates["pltermpremiumclass1noemp"];
                }
            } else
            {
                if (feeincome >= 0 && feeincome <= 500000)
                {
                    if (employeenumber > 0)
                    {
                        basepremium = rates["below500kfeeincomebasepremium"];
                    }
                    else
                    {
                        basepremium = rates["below500kfeeincomebasepremiumnoemp"];
                    }
                }
                else if (feeincome > 500000 && feeincome <= 750000)
                {
                    if (employeenumber > 0)
                    {
                        basepremium = rates["500kto750kfeeincomebasepremium"];
                    }
                    else
                    {
                        basepremium = rates["500kto750kfeeincomebasepremiumnoemp"];
                    }
                }
                else if (feeincome > 750000 && feeincome <= 1000000)
                {
                    if (employeenumber > 0)
                    {
                        basepremium = rates["750kto1milfeeincomebasepremium"];
                    }
                    else
                    {
                        basepremium = rates["750kto1milfeeincomebasepremiumnoemp"];
                    }
                }
                else if (feeincome > 1000000 && feeincome <= 1500000)
                {
                    if (employeenumber > 0)
                    {
                        basepremium = rates["1milto1andhalfmilfeeincomebasepremium"];
                    }
                    else
                    {
                        basepremium = rates["1milto1andhalfmilfeeincomebasepremiumnoemp"];
                    }
                }
                else if (feeincome > 1500000 && feeincome <= 2000000)
                {
                    if (employeenumber > 0)
                    {
                        basepremium = rates["1andhalfmilto2milfeeincomebasepremium"];
                    }
                    else
                    {
                        basepremium = rates["1andhalfmilto2milfeeincomebasepremiumnoemp"];
                    }
                }
                else if (feeincome > 2000000 && feeincome <= 3000000)
                {
                    if (employeenumber > 0)
                    {
                        basepremium = rates["2milto3milfeeincomebasepremium"];
                    }
                    else
                    {
                        basepremium = rates["2milto3milfeeincomebasepremiumnoemp"];
                    }
                }

                premium = basepremium + (rolenumber - 2) * rates["pltermpremiumtopup"];
        ...
        void uwrffeeincomeover3mil(User underwritingUser, ClientAgreement agreement, decimal feeincomelastyear)
        {
            if (agreement.ClientAgreementReferrals.FirstOrDefault(cref => cref.ActionName == "uwrffeeincomeover3mil" && cref.DateDeleted == null) == null)
            {
                if (agreement.ClientAgreementRules.FirstOrDefault(cr => cr.RuleCategory == "uwreferral" && cr.DateDeleted == null && cr.Value == "uwrffeeincomeover3mil") != null)
                    agreement.ClientAgreementReferrals.Add(new ClientAgreementReferral(underwritingUser, agreement, agreement.ClientAgreementRules.FirstOrDefault(cr => cr.RuleCategory == "uwreferral" && cr.DateDeleted == null && cr.Value == "uwrffeeincomeover3mil").Name,
                        agreement.ClientAgreementRules.FirstOrDefault(cr => cr.RuleCategory == "uwreferral" && cr.DateDeleted == null && cr.Value == "uwrffeeincomeover3mil").Description,
                        "",
                        agreement.ClientAgreementRules.FirstOrDefault(cr => cr.RuleCategory == "uwreferral" && cr.DateDeleted == null && cr.Value == "uwrffeeincomeover3mil").Value,
                        agreement.ClientAgreementRules.FirstOrDefault(cr => cr.RuleCategory == "uwreferral" && cr.DateDeleted == null && cr.Value == "uwrffeeincomeover3mil").OrderNumber,
                        agreement.ClientAgreementRules.FirstOrDefault(cr => cr.RuleCategory == "uwreferral" && cr.DateDeleted == null && cr.Value == "uwrffeeincomeover3mil").DoNotCheckForRenew));
            }
            else
            {
                if (agreement.ClientAgreementReferrals.FirstOrDefault(cref => cref.ActionName == "uwrffeeincomeover3mil" && cref.DateDeleted == null).Status != "Pending")
                {
                    if (feeincomelastyear > 3000000) //Fee Income Over $3mil referral
                    {
                        agreement.ClientAgreementReferrals.FirstOrDefault(cref => cref.ActionName == "uwrffeeincomeover3mil" && cref.DateDeleted == null).Status = "Pending";
                    }
                }

                if (agreement.ClientInformationSheet.IsRenewawl
                            && agreement.ClientAgreementReferrals.FirstOrDefault(cref => cref.ActionName == "uwrffeeincomeover3mil" && cref.DateDeleted == null).DoNotCheckForRenew)
                {
                    agreement.ClientAgreementReferrals.FirstOrDefault(cref => cref.ActionName == "uwrffeeincomeover3mil" && cref.DateDeleted == null).Status = "";
                }
            }
        }

        void uwrfadvisornumberover20(User underwritingUser, ClientAgreement agreement, int rolenumber)
        {
            if (agreement.ClientAgreementReferrals.FirstOrDefault(cref => cref.ActionName == "uwrfadvisornumberover20" && cref.DateDeleted == null) == null)
            {
                if (agreement.ClientAgreementRules.FirstOrDefault(cr => cr.RuleCategory == "uwreferral" && cr.DateDeleted == null && cr.Value == "uwrfadvisornumberover20") != null)
                    agreement.ClientAgreementReferrals.Add(new ClientAgreementReferral(underwritingUser, agreement, agreement.ClientAgreementRules.FirstOrDefault(cr => cr.RuleCategory == "uwreferral" && cr.DateDeleted == null && cr.Value == "uwrfadvisornumberover20").Name,
                        agreement.ClientAgreementRules.FirstOrDefault(cr => cr.RuleCategory == "uwreferral" && cr.DateDeleted == null && cr.Value == "uwrfadvisornumberover20").Description,
                        "",
                        agreement.ClientAgreementRules.FirstOrDefault(cr => cr.RuleCategory == "uwreferral" && cr.DateDeleted == null && cr.Value == "uwrfadvisornumberover20").Value,
                        agreement.ClientAgreementRules.FirstOrDefault(cr => cr.RuleCategory == "uwreferral" && cr.DateDeleted == null && cr.Value == "uwrfadvisornumberover20").OrderNumber,
                        agreement.ClientAgreementRules.FirstOrDefault(cr => cr.RuleCategory == "uwreferral" && cr.DateDeleted == null && cr.Value == "uwrfadvisornumberover20").DoNotCheckForRenew));
            }
            else
            {
                if (agreement.ClientAgreementReferrals.FirstOrDefault(cref => cref.ActionName == "uwrfadvisornumberover20" && cref.DateDeleted == null).Status != "Pending")
                {
                    if (rolenumber > 20) //Advisor No Over 20 referral
                    {
                        agreement.ClientAgreementReferrals.FirstOrDefault(cref => cref.ActionName == "uwrfadvisornumberover20" && cref.DateDeleted == null).Status = "Pending";
                    }
                }

                if (agreement.ClientInformationSheet.IsRenewawl
                            && agreement.ClientAgreementReferrals.FirstOrDefault(cref => cref.ActionName == "uwrfadvisornumberover20" && cref.DateDeleted == null).DoNotCheckForRenew)
                {
                    agreement.ClientAgreementReferrals.FirstOrDefault(cref => cref.ActionName == "uwrfadvisornumberover20" && cref.DateDeleted == null).Status = "";
                }
            }
        }

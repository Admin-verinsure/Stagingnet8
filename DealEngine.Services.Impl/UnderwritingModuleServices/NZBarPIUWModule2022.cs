...
{
    public class NZBarPIUWModule2022 : IUnderwritingModule
    {
        public string Name { get; protected set; }

        public NZBarPIUWModule2022()
        {
            Name = "NZBar_PI_2022";
        }
        ...
        public bool Underwrite(User underwritingUser, ClientInformationSheet informationSheet, Product product, string reference)
        {
            ...
            if (agreement.ClientInformationSheet.RevenueData != null)
            {
                ...
                {
                    if (uISActivity.AnzsciCode == "CUSNZBar23") //Criminal Law
                    {
            ...
            //additinal premium for "With Employees"
            decimal decadditionpremium = 0M;
            if (agreement.ClientInformationSheet.Answers.Where(sa => sa.ItemName == "EPLViewModel.HaveAnyEmployeeYN").Any())
            {
            ...
            TermPremium2millimit5kexcess += decadditionpremium;
            ...
            TermPremium2millimit10kexcess += decadditionpremium;
            ...
            TermPremium5millimit5kexcess += decadditionpremium;
            ...
            TermPremium5millimit10kexcess += decadditionpremium;
            ...
            if (!boljuniorbarrister) //None Junior Barrister Pricing
            {
                ...
                TermPremium10millimit5kexcess += decadditionpremium;
                ...
                TermPremium10millimit10kexcess += decadditionpremium;

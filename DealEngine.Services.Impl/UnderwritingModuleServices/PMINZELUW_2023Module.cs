...
{
    public class PMINZELUW_2023Module : IUnderwritingModule
    {
        public string Name { get; protected set; }

        public PMINZELUW_2023Module()
        {
            Name = "PMINZ_EL_2023";
        }
        ...
        public bool Underwrite(User underwritingUser, ClientInformationSheet informationSheet, Product product, string reference)
        {
            ...
            IDictionary<string, decimal> rates = BuildRulesTable(agreement, "el500klimitpremium", "eltopuppremiumover4employee");
            ...
            decimal TermPremium500k = rates["el500klimitpremium"];
            ...
            {
                TermPremium500k += (Convert.ToInt32(agreement.ClientInformationSheet.Answers.Where(sa => sa.ItemName == "EPLViewModel.TotalEmployees").First().Value) - 4) * rates["eltopuppremiumover4employee"];
            }

            ClientAgreementTerm termsl250klimitoption = GetAgreementTerm(underwritingUser, agreement, "EL", TermLimit500k, TermExcess);
            termsl250klimitoption.TermLimit = TermLimit500k;
            termsl250klimitoption.Premium = TermPremium500k;
            termsl250klimitoption.Excess = TermExcess;
            termsl250klimitoption.BrokerageRate = agreement.Brokerage;
            termsl250klimitoption.Brokerage = TermBrokerage500k;
            termsl250klimitoption.DateDeleted = null;
            termsl250klimitoption.DeletedBy = null;
            termsl250klimitoption.BasePremium = TermPremium500k;
            ...
            if (agreement.ClientInformationSheet.IsChange && agreement.ClientInformationSheet.PreviousInformationSheet != null)
            {
                ...
                foreach (var term in PreviousAgreement.ClientAgreementTerms)
                {
                    if (term.Bound)
                    {
                        ...
                        termsl250klimitoption.PremiumDiffer = (TermPremium500k - PreviousBoundPremium) * coverperiodindaysforchange / agreementperiodindays;
            ...
            string retrodate = agreement.InceptionDate.ToString("dd/MM/yyyy"); //"Inception or Date since EL policy first held"
            ...
            {
                var PreviousAgreement1 = agreement.ClientInformationSheet.PreviousInformationSheet.Programme.Agreements.FirstOrDefault(p => p.ClientAgreementTerms.Any(i => i.SubTermType == "EL"));

...
namespace DealEngine.Services.Impl.UnderwritingModuleServices
{
    public class DANZPIUWModule : IUnderwritingModule
    {
        ...
        public bool Underwrite(User underwritingUser, ClientInformationSheet informationSheet, Product product, string reference)
        {
            ...
            //Excluded Activities (I.e. Structural Engineer, Building Services Engineer, Inspection reports, Valuations, Other)
            uwrfexcludedactivities(underwritingUser, agreement, decBSS, decSE, decIR, decVal, decOther);
        ...
        void uwrfexcludedactivities(User underwritingUser, ClientAgreement agreement, decimal decBSS, decimal decSE, decimal decIR, decimal decVal, decimal decOther)
        {
            ...
            else
            {
                ...
                {
                    if (decBSS > 0 || decSE > 0 || decIR > 0|| decVal > 0 || decOther > 0)
                    {

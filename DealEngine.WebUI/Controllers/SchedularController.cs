...
{
    public class SchedularController : IHostedService
    {
        ...
        public SchedularController(ISchedulerFactory schedulerFactory, List<JobMetadata> jobMetadatas, IJobFactory jobFactory)
        {
